...
This script is licensed under the [MIT License] (LICENSE), which means it is free to use, modify, and distribute for personal or commercial purposes.

## Contribution

Contributions to this script are welcome! If you find any issues or have suggestions for improvement, please feel free to submit a pull request or open an issue on the GitHub repository.
